const CoinFlipFactory = artifacts.require('./levels/level-3/CoinFlipFactory.sol')
const CoinFlip = artifacts.require('./levels/level-3/CoinFlip.sol')
const CoinFlipAttack = artifacts.require('./levels/level-3/CoinFlipAttack.sol')
